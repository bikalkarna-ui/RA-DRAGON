          ...
          <div className="space-y-3">
            {[
              ...
              <div key={row.label} className="flex justify-between py-2 border-b border-gray-50 last:border-0">
                <span className={cn('text-sm', row.bold ? 'font-bold text-text' : 'text-gray-700')}>{row.label}</span>
                <span className={cn('num text-sm font-bold', row.color || (row.bold ? 'text-text' : 'text-gray-800'))}>
