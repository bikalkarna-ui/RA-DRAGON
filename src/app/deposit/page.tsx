        ...
        {report && (
          <div id="deposit-slip" className="tile overflow-hidden">
            ...
            <div className="bg-accent text-white p-6 text-center">
              <p className="font-black text-xl">{store?.name || 'Store'}</p>
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div key={row.label} className="flex justify-between py-2 border-b border-gray-200">
                ...
                <div>
                  ...
                  {(report.checks_given || []).map((c: any, i: number) => (
                    <div key={i} className="flex justify-between py-2 border-b border-gray-200">
                      <span className="text-sm text-gray-700">#{c.number} {c.payee}</span>
              ...
              <p className="text-xs text-muted text-center">{store?.name} · {date} · Generated by RYXSOR AI</p>
            </div>
          </div>
        )}
