...
export default function SearchPage() {
  ...
  const COLOR: Record<ResultType, string> = { product: 'bg-blue-500/10 text-blue-400', invoice: 'bg-pink-500/10 text-pink-400', employee: 'bg-cyan-500/10 text-cyan-400', report: 'bg-red-500/10 text-accent' };
